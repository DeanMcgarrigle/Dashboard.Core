namespace Dashboard.Core
{
    partial class ProjectInstaller
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.winServiceProcessInstaller.AfterInstall += new System.Configuration.Install.InstallEventHandler(this.winServiceProcessInstaller_AfterInstall);
            // 
            // winServiceInstaller
            // 
            this.winServiceInstaller.DelayedAutoStart = true;
            this.winServiceInstaller.ServiceName = "WinService";
